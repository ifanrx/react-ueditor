...
var UploadModal = function (_React$Component) {
  ...
  function UploadModal() {
    ...
    _this.showErrorMsg = _this.showErrorMsg.bind(_this);
  ...
  _createClass(UploadModal, [{
    ...
    value: function showErrorMsg(msg) {
      ...
      timeoutInstance = setTimeout(function () {
        _this3.setState({ errorMsg: '', errorMsgVisible: false });
      }, 4000);
    }
  }, {
    key: 'getFileType',
        ...
        if (type === 'audio') {
          if (len === 1) {
            ...
            sources.forEach(function (source) {
              html += '<source src=' + source + ' type="audio/' + _this4.getFileType(source, 'audio') + '">';
            });
          ...
          if (len === 1) {
            ...
            sources.forEach(function (source) {
              html += '<source src=' + source + ' type="video/' + _this4.getFileType(source, 'video') + '"}>';
            });
    ...
    value: function renderSourceList() {
      ...
      if (sources.length > 0) {
        var list = sources.map(function (source, index) {
          return _react2.default.createElement(_Tag2.default, { value: source, key: source, index: index, onRemove: _this5.removeSource });
        });
        return list;
      } else {
    ...
    value: function renderAudioConfig() {
      ...
      var _state4 = this.state,
          controls = _state4.controls,
          autoplay = _state4.autoplay,
          loop = _state4.loop,
          poster = _state4.poster,
          name = _state4.name,
          author = _state4.author;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Select2.default,
            { defaultValue: controls, onChange: function onChange(e) {
                _this7.changeConfig(e, 'controls');
              } },
            _react2.default.createElement(
              'option',
              { value: 'true' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Select2.default,
            { defaultValue: autoplay, onChange: function onChange(e) {
                _this7.changeConfig(e, 'autoplay');
              } },
            _react2.default.createElement(
              'option',
              { value: 'true' },
    ...
    value: function render() {
      var _state5 = this.state,
          currentSource = _state5.currentSource,
          sources = _state5.sources,
          width = _state5.width,
          height = _state5.height,
          controls = _state5.controls,
          autoplay = _state5.autoplay,
          muted = _state5.muted,
          loop = _state5.loop,
          errorMsg = _state5.errorMsg,
          errorMsgVisible = _state5.errorMsgVisible;
