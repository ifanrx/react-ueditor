...
var ReactUeditor = function (_React$Component) {
  ...
  function ReactUeditor() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = ReactUeditor.__proto__ || Object.getPrototypeOf(ReactUeditor)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {
