...
var ReactUeditor = /*#__PURE__*/function (_React$Component) {
      ...
      return _this.registerPlugin(function (ueditor) {
        return {
          ...
          render: function render() {
            return /*#__PURE__*/_react["default"].createElement(_VideoUploader["default"], {
              upload: uploadVideo,
              progress: progress,
    ...
    _defineProperty(_assertThisInitialized(_this), "registerUploadAudio", function () {
      ...
      return _this.registerPlugin(function (ueditor) {
        return {
          ...
          mode: MODE.INTERNAL_MODAL,
          render: function render() {
            return /*#__PURE__*/_react["default"].createElement(_AudioUploader["default"], {
              upload: uploadAudio,
              progress: progress,
          ...
          onConfirm: function onConfirm() {
            ...
            ueditor.execCommand('insertparagraph');
            ueditor.execCommand('insertparagraph'); // 清空
          }
        };
      });
    });
