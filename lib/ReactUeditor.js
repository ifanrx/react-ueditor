...
function (_React$Component) {
  ...
  function ReactUeditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "registerUploadVideo", function () {
      ...
      _this.state.extendControls.unshift({
        ...
        onConfirm: function onConfirm() {
          _this.insert(_this.state.videoHtml);
        }
      });

      _this.setState({
        extendControls: _this.state.extendControls
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "registerUploadAudio", function () {
      ...
      _this.state.extendControls.unshift({
        ...
        onConfirm: function onConfirm() {
          _this.insert(_this.state.audioHtml);
        }
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "insert", function (html) {
      if (_this.ueditor) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePasteImage", function () {
      ...
      var iframe = document.getElementById(_this.containerID).querySelector('iframe');
      ...
      images.forEach(function (src) {
        ...
        if (!!promise && typeof promise.then == 'function') {
          promise.then(function (newSrc) {
            var newHtml = utils.replaceImageSource(doc.body.innerHTML, src, newSrc);
