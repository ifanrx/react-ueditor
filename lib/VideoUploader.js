...
function (_React$PureComponent) {
  ...
  function UploadModal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateCurrentSource", function (e) {
      _this.setState({
        currentSource: e.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addSource", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "removeSource", function (index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "upload", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showErrorMsg", function (msg) {
      _this.setState({
        errorMsg: msg,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getFileType", function (fileUrl, mediaType) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderSourceList", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderVideoConfig", function () {
